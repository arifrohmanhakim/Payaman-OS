...
export default function AppIconGraphic({ iconType, className = 'w-10 h-10' }) {
  ...
  switch (iconType) {
    ...
    case 'trash-full':
    case 'wastebasket-full':
      return (
        <svg {...pixelSvgProps}>
          {/* Overflowing crumpled papers */}
          <rect x="4" y="0" width="3" height="2" />
          <rect x="9" y="0" width="3" height="2" />
          <rect x="6" y="1" width="4" height="2" fill="var(--os-bg)" stroke="currentColor" strokeWidth="0.5" />
          <rect x="3" y="2" width="10" height="2" />
          <rect x="4" y="2.5" width="2" height="1" fill="var(--os-bg)" />
          <rect x="8" y="2.5" width="3" height="1" fill="var(--os-bg)" />
          {/* Bulging Bin Body */}
          <rect x="2" y="4" width="12" height="11" />
          <rect x="3" y="5" width="10" height="9" fill="var(--os-bg)" />
          {/* Crumpled paper texture inside bin */}
    ...
    case 'quicklook':
      return (
        <svg {...pixelSvgProps}>
          ...
          <rect x="7" y="7" width="2" height="2" fill="var(--os-bg)" />
        </svg>
      )
    ...
    case 'copy':
      return (
        <svg {...pixelSvgProps}>
          ...
          <rect x="2" y="5" width="8" height="9" fill="none" stroke="currentColor" strokeWidth="1" />
        </svg>
      )
