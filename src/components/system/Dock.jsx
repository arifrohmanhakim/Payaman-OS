    ...
    switch (size) {
      case 'small':
        return {
          ...
          containerPadding: position === 'bottom' ? 'px-1.5 py-1' : 'px-1 py-1.5',
        }
      case 'large':
        return {
      ...
      default:
        return {
          ...
          dot: 'w-1.5 h-1.5',
          activeDot: 'w-2 h-1',
          containerPadding: position === 'bottom' ? 'px-2.5 py-1.5' : 'px-1.5 py-2.5',
        }
    }
  }
    ...
    switch (position) {
      case 'left':
        return {
          ...
          hoverMove: magnification ? 'hover:translate-x-1.5 hover:scale-110' : '',
      ...
      default:
        return {
          ...
          divider: 'w-[1.5px] h-6 bg-[var(--os-border)]/40 self-center mx-1 my-auto',
          tooltip: 'bottom-full mb-2 left-1/2 -translate-x-1/2',
          hoverMove: magnification ? 'hover:-translate-y-1.5 hover:scale-110' : '',
  ...
  const renderDockItem = (app) => {
    ...
    return (
      ...
      >
        ...
        >
          <AppIconGraphic iconType={app.iconType} className={sizeClasses.icon} />
        </button>
